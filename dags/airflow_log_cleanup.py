...
# DEFAULT_MAX_LOG_AGE_IN_DAYS = int(Variable.get(
#     "airflow_log_cleanup__max_log_age_in_days", 2)
# )
...
with DAG(
    ...
    try:
        BASE_LOG_FOLDER = conf.get("logging", "BASE_LOG_FOLDER").rstrip("/")    # update: core -> logging
    except Exception as e:
        BASE_LOG_FOLDER = conf.get("logging", "BASE_LOG_FOLDER").rstrip("/")
    DEFAULT_MAX_LOG_AGE_IN_DAYS = int(Variable.get(
    "airflow_log_cleanup__max_log_age_in_days", 2))
